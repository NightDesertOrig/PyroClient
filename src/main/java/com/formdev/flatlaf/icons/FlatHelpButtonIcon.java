...
public class FlatHelpButtonIcon extends FlatAbstractIcon {
   ...
   protected void paintIcon(Component c, Graphics2D g2) {
      ...
      if (focused && FlatButtonUI.isFocusPainted(c)) {
         ...
         g2.fill(new Float(0.5F, 0.5F, (float)(this.iconSize - 1), (float)(this.iconSize - 1)));
      }
      ...
      g2.fill(new Float((float)this.focusWidth + 0.5F, (float)this.focusWidth + 0.5F, 21.0F, 21.0F));
      ...
      g2.fill(new Float((float)this.focusWidth + 1.5F, (float)this.focusWidth + 1.5F, 19.0F, 19.0F));
      Path2D q = new java.awt.geom.Path2D.Float();
      q.moveTo(11.0D, 5.0D);
