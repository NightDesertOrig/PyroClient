...
public class FlatComboBoxUI extends BasicComboBoxUI {
   ...
   protected void installListeners() {
      ...
      this.hoverListener = new FlatUIUtils.HoverListener((Component)null, (h) -> {
   ...
   public void paintCurrentValue(Graphics g, Rectangle bounds, boolean hasFocus) {
      ...
      Insets rendererInsets = this.getRendererComponentInsets(c);
   ...
   private void uninstallCellPaddingBorder(Object o) {
      FlatComboBoxUI.CellPaddingBorder.uninstall(o);
      if (this.lastRendererComponent != null) {
         FlatComboBoxUI.CellPaddingBorder.uninstall(this.lastRendererComponent);
   ...
   private static class CellPaddingBorder extends AbstractBorder {
      ...
      static void uninstall(Object o) {
         ...
         if (o instanceof JComponent) {
            ...
            if (border instanceof FlatComboBoxUI.CellPaddingBorder) {
               FlatComboBoxUI.CellPaddingBorder paddingBorder = (FlatComboBoxUI.CellPaddingBorder)border;
   ...
   protected class FlatComboPopup extends BasicComboPopup {
      ...
      protected PropertyChangeListener createPropertyChangeListener() {
         return new javax.swing.plaf.basic.BasicComboPopup.PropertyChangeHandler() {
            public void propertyChange(PropertyChangeEvent e) {
               super.propertyChange(e);
               if (e.getPropertyName() == "renderer") {
                  FlatComboPopup.this.list.setCellRenderer(FlatComboPopup.this.new PopupListCellRenderer());
               }
         ...
         public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (c instanceof JComponent) {
               if (FlatComboPopup.this.paddingBorder == null) {
                  FlatComboPopup.this.paddingBorder = new FlatComboBoxUI.CellPaddingBorder(FlatComboBoxUI.this.padding);
               }
   ...
   protected class FlatComboBoxButton extends FlatArrowButton {
      protected FlatComboBoxButton() {
         this(5, FlatComboBoxUI.this.arrowType, FlatComboBoxUI.this.buttonArrowColor, FlatComboBoxUI.this.buttonDisabledArrowColor, FlatComboBoxUI.this.buttonHoverArrowColor, (Color)null, (Color)null);
      }

      protected FlatComboBoxButton(int direction, String type, Color foreground, Color disabledForeground, Color hoverForeground, Color hoverBackground, Color pressedBackground) {
