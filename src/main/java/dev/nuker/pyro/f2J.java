...
public class f2J
implements Command {
    public static f2J Field3738 = new f2J();
    ...
    public int Method152(@Nullable CommandContext commandContext) {
        ...
        if (optional.isPresent()) {
            if (((Boolean)((Module)optional.get()).Field5236.Method5264()).booleanValue()) {
                ((Module)optional.get()).Field5236.Method5266((Object)false);
                ...
                ((f1s)s).Method5489(new TextComponentString("Disabled Module: ").appendSibling(new TextComponentString(((Module)optional.get()).Method7265()).setStyle(new Style().setColor(TextFormatting.DARK_AQUA))));
            } else {
                ...
                ((f1s)s).Method5489(new TextComponentString("Module Already Disabled: ").appendSibling(new TextComponentString(((Module)optional.get()).Method7265()).setStyle(new Style().setColor(TextFormatting.DARK_AQUA))));
            }
        } else {
            String string2;
